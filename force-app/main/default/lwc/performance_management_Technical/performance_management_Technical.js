...
import createAssessmentRecords from '@salesforce/apex/Assessmentyear.createTechAssessmentRecords';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
//import { createRecord } from 'lightning/uiRecordApi';
export default class Performance_management_Technical extends LightningElement {
            ...
            try {
                ...
                const assessmentRecords = [];
                    const assessmentRecord = {
                        sobjectType: 'Technical_Assessment__c',
                        Milestone_1__c: this.milestValues[0],
                        Milestone_2__c: this.milestValues[1],
                        Milestone_3__c: this.milestValues[2],
                        Milestone_4__c: this.milestValues[3],
