...
// import getButtonNames from '@salesforce/apex/Technical_manager.getButtonNames';
import salesmilestones from '@salesforce/apex/search_SalesASS.getButtonNames';
// import Marketingmilestones from '@salesforce/apex/Marketing_manager.getButtonNames';
import { CurrentPageReference } from 'lightning/navigation';
import getAssessmentYears from '@salesforce/apex/Assessmentyear.yearsList';
import createAssessmentRecords from '@salesforce/apex/Assessmentyear.createAssessmentRecords';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
//import { createRecord } from 'lightning/uiRecordApi';

export default class performance_management_Sales extends LightningElement {
...
selectedMilestone;
 ...
 @wire(CurrentPageReference)
    setCurrentPageReference(reference) {
        ...
        @wire(salesmilestones)
    wiredSalesButtonNames({ error, data }) {
        if (data) {
            this.salesButtonNames = data;
           console.log('Sales Button Names: ' + JSON.stringify(this.salesButtonNames));
        } else if (error) {
            ...
            try {
                ...
                const assessmentRecords = [];
                    const assessmentRecord = {
                        sobjectType: 'Sale1_Assessment__c',
                        ...
                        Employee_Comments__c: this.comments[0],
